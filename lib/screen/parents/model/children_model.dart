...
class Child extends FirestoreModel {
  ...
  Map<String, dynamic> toMap() => {
    ...
    if (autismCentreName != null) 'autismCentreName': autismCentreName, // New field
  ...
  factory Child.fromMap(String id, Map<String, dynamic> map) => Child(
    ...
    name: map['name'] ?? '',
    myKid: map['myKid'] ?? map['myKidNumber'] ?? '', // Handle both field names
  ...
  factory Child.fromJson(Map<String, dynamic> json) {
    return Child(
      ...
      hasAttendedCenter: json['hasAttendedCenter'] as bool,
